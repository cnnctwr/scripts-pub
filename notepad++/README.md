[README.md](https://github.com/user-attachments/files/30192377/README.md)
# Notepad++ Auto-Update
...
> automatischen Lauf (taeglich, 03:00 Uhr) mit "Datei nicht gefunden" fehl.
...
1. Geplante Aufgabe **"Notepad++ Update"** in der Aufgabenplanung loeschen, entweder ueber die
   GUI oder per PowerShell:
   ```powershell
